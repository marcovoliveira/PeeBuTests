...
class CheckTransactionsListFilteredBySourceStepsDef {


	@When("the user click on the source column at the transactions list")
	public void the_user_click_on_the_entity_column_at_the_transactions_list() {
		WebUI.click(findTestObject('Page_client/span_Source'))
	}

	@Then("the user sees a transactions list filtered by source")
	public void the_user_sees_a_transactions_list_filtered_by_source() {
		WebDriver driver = DriverFactory.getWebDriver()
		List<WebElement> tableElements = driver.findElements(By.cssSelector("#inspire tr td:nth-child(5)"));
